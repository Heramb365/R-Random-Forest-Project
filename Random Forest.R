...
ggsave("oob_error_rate_500_trees.jpg")
...
ggplot(data=oob.error.data, aes(x=Trees, y=Error)) +
  geom_line(aes(color=Type))
ggsave("oob_error_rate_1000_trees.jpg")
...
## now make a plot that shows the MDS axes and the variation:
...
ggplot(data=mds.data, aes(x=X, y=Y, label=Sample)) + 
 ...
 ggsave(file="random_forest_mds_plot.jpg")